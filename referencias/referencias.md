...
Goodrich, M. T., Tamassia, R., & Goldwasser, M. H. (2013). *Data structures and algorithms in Python*. Wiley. https://www.wiley.com/en-us/Data%2BStructures%2Band%2BAlgorithms%2Bin%2BPython-p-9781118290279

Goodrich, M. T., Tamassia, R., & Mount, D. M. (2011). *Data structures and algorithms in C++* (2nd ed.). Wiley. https://www.wiley.com/en-us/Data%2BStructures%2Band%2BAlgorithms%2Bin%2BC%2B%2B%2C%2B2nd%2BEdition-p-9781118136638
...
Knuth, D. E. (1976). Big omicron and big omega and big theta. *ACM SIGACT News, 8*(2), 18-24. https://doi.org/10.1145/1008328.1008329

Knuth, D. E. (1997). *The art of computer programming: Volume 1. Fundamental algorithms* (3rd ed.). Addison-Wesley.

Liskov, B., & Zilles, S. (1974). Programming with abstract data types. *ACM SIGPLAN Notices, 9*(4), 50-59. https://doi.org/10.1145/942572.807045

Python Software Foundation. (2026). *Data structures*. Python 3.14.7 documentation. https://docs.python.org/3/tutorial/datastructures.html

Sedgewick, R., & Wayne, K. (2011). *Algorithms* (4th ed.). Addison-Wesley Professional. https://algs4.cs.princeton.edu/home/
